...
def debug_combinecmd_hzz_new_min_settings(args):
    cmd = [
        ...
        '--floatOtherPOIs=1',
        '-P ct -P cg',
        '--setParameterRanges ct=-6.0,6.0:cg=-0.45,0.45',
        '--setParameters ct=1.0,cg=0.0,lumiscale=83.56546',
        '--saveWorkspace',
        ]
...
def debug_combinecmd_floatingbrs(args):
    cmd = [
        ...
        '-P kappab',
        '-P kappac',
        '--setParameters kappab=1.0,kappac=1.0,lumiscale=83.56546',
        '--algo=grid',
        '--snapshotName MultiDimFit',
        '--skipInitialFit',
        '-M MultiDimFit',
        '-m 125.0',
        '--setParameterRanges kappab=-5.0,8.0:kappac=-16.0,18.0',
        '--points 900',
        '--firstPoint 0',
        '--lastPoint 99',
        '-n debugscan1',
...
def debug_scan_hgg_Mar15_pth_ggH_GT600_bestfit(args):
    cmd = [
        ...
        '-v 1',
        '-P r_ggH_PTH_GT600',
        '--setParameterRanges r_ggH_PTH_0_15=-1.0,4.0:r_ggH_PTH_15_30=-1.0,4.0:r_ggH_PTH_30_45=-1.0,4.0:r_ggH_PTH_45_80=-1.0,4.0:r_ggH_PTH_80_120=-1.0,4.0:r_ggH_PTH_120_200=-1.0,4.0:r_ggH_PTH_200_350=-1.0,4.0:r_ggH_PTH_350_600=-15.0,10.0:r_ggH_PTH_GT600=-1000.0,10.0',
        '--setParameters r_ggH_PTH_0_15=1.0,r_ggH_PTH_15_30=1.0,r_ggH_PTH_30_45=1.0,r_ggH_PTH_45_80=1.0,r_ggH_PTH_80_120=1.0,r_ggH_PTH_120_200=1.0,r_ggH_PTH_200_350=1.0,r_ggH_PTH_350_600=1.0,r_ggH_PTH_GT600=1.0',
        ]
    differentials.core.execute(cmd)
...
def debug_scan_hgg_Mar15_pth_smH(args):
    cmd = [
        ...
        '-v 1',
        '-P r_smH_PTH_GT600',
        '--setParameters r_smH_PTH_0_15=1.0,r_smH_PTH_15_30=1.0,r_smH_PTH_30_45=1.0,r_smH_PTH_45_80=1.0,r_smH_PTH_80_120=1.0,r_smH_PTH_120_200=1.0,r_smH_PTH_200_350=1.0,r_smH_PTH_350_600=1.0,r_smH_PTH_GT600=1.0',
        '--algo=grid',
        '-M MultiDimFit',
        '-m 125.0',
        '--setParameterRanges r_smH_PTH_0_15=-1.0,4.0:r_smH_PTH_15_30=-1.0,4.0:r_smH_PTH_30_45=-1.0,4.0:r_smH_PTH_45_80=-1.0,4.0:r_smH_PTH_80_120=-1.0,4.0:r_smH_PTH_120_200=-1.0,4.0:r_smH_PTH_200_350=-1.0,4.0:r_smH_PTH_350_600=-15.0,10.0:r_smH_PTH_GT600=-10.0,20.0',
        '--points 40',
        '--firstPoint 5',
        '--lastPoint 7',
...
def debug_scan_hgg_Mar15_pth_ggH(args):
    cmd = [
        ...
        '-M MultiDimFit',
        '-m 125.0',
        '--setParameterRanges r_ggH_PTH_0_15=-1.0,4.0:r_ggH_PTH_15_30=-1.0,4.0:r_ggH_PTH_30_45=-1.0,4.0:r_ggH_PTH_45_80=-1.0,4.0:r_ggH_PTH_80_120=-1.0,4.0:r_ggH_PTH_120_200=-1.0,4.0:r_ggH_PTH_200_350=-1.0,4.0:r_ggH_PTH_350_600=-15.0,10.0:r_ggH_PTH_GT600=-10.0,20.0',
        '--points 40',
        '--firstPoint 5',
        '--lastPoint 7',
        '--saveSpecifiedIndex {0}'.format(','.join(pdf_indices))
...
def debug_scan_hzz_Mar15(args):
    cmd = [
        ...
        # '-v -1',
        '-P r_ggH_PTH_GT200',
        '--setParameterRanges r_ggH_PTH_0_15=0.0,4.0:r_ggH_PTH_15_30=0.0,4.0:r_ggH_PTH_30_80=0.0,4.0:r_ggH_PTH_80_200=0.0,4.0:r_ggH_PTH_GT200=-10.0,1.0',
        '--setParameters r_ggH_PTH_0_15=1.0,r_ggH_PTH_15_30=1.0,r_ggH_PTH_30_80=1.0,r_ggH_PTH_80_200=1.0,r_ggH_PTH_GT200=1.0',
        '--algo=grid',
        '--points=40',
        ]
    differentials.core.execute(cmd)
...
def debug_Scan_hbb(args):
    cmd = [
        ...
        '--floatOtherPOIs=1',
        '-P r_ggH_PTH_350_600',
        '--setParameterRanges r_ggH_PTH_200_350=-10.0,10.0:r_ggH_PTH_350_600=-10.0,10.0:r_ggH_PTH_GT600=-10.0,10.0',
        # :qcdeff=0.001,8.0:r1p0=0.0,8.0:r2p0=0.0,8.0:r3p0=0.0,8.0:r0p1=0.0,8.0:r1p1=0.0,8.0:r2p1=0.0,8.0:r3p1=0.0,8.0',
        # '--setParameters r_ggH_PTH_200_350=1.0,r_ggH_PTH_350_600=1.0,r_ggH_PTH_GT600=1.0',
        '--algo=grid',
        '--points=3',
        #
        '--snapshotName MultiDimFit',
...
def debug_combWithHbb_Scan_Mar02(args):
    ...
    # --floatOtherPOIs=1
    # -P r_ggH_PTH_350_600
    # --setParameters r_ggH_PTH_GT600=1.0,r_ggH_PTH_350_600=1.0
    # --squareDistPoi
    # --saveNLL
    # --saveInactivePOI 1
    # -t -1
    ...
    # -M MultiDimFit
    # -m 125.00
    # --setParameterRanges r_ggH_PTH_350_600=-10.000,10.000
...
def debug_hbb_bestfit(args):
    cmd = [
        ...
        '--setParameterRanges r_ggH_PTH_200_350=-10.0,10.0:r_ggH_PTH_350_600=-10.0,10.0:r_ggH_PTH_GT600=-10.0,10.0:qcdeff=0.001,8.0:r1p0=0.0,8.0:r2p0=0.0,8.0:r3p0=0.0,8.0:r0p1=0.0,8.0:r1p1=0.0,8.0:r2p1=0.0,8.0:r3p1=0.0,8.0',
        '--setParameters r_ggH_PTH_200_350=1.0,r_ggH_PTH_350_600=1.0,r_ggH_PTH_GT600=1.0',
        '--saveWorkspace',
        ]
    differentials.core.execute(cmd)
...
def debug_combWithHbb_Mar01(args):
    ...
    cmd = [
        ...
        # '--job-mode psi --task-name _SCAN_bPOI_r_ggH_PTH_600_10000_ePOI_ws_pth_ggH_combWithHbb --sub-opts='-q short.q' ',
        '-P r_ggH_PTH_GT600',
        '--setParameterRanges r_ggH_PTH_0_15=0.0,8.5:r_ggH_PTH_15_30=0.0,8.5:r_ggH_PTH_30_45=0.0,8.5:r_ggH_PTH_45_80=0.0,8.5:r_ggH_PTH_80_120=0.0,8.5:r_ggH_PTH_120_200=0.0,8.5:r_ggH_PTH_200_350=0.0,8.5:r_ggH_PTH_350_600=0.0,8.5:r_ggH_PTH_GT600=0.0,8.5:r_ggH_PTH_600_10000=0.0,8.5:qcdeff=0.001,8.0:r1p0=0.0,8.0:r2p0=0.0,8.0:r3p0=0.0,8.0:r0p1=0.0,8.0:r1p1=0.0,8.0:r2p1=0.0,8.0:r3p1=0.0,8.0',
        '--setParameters r_ggH_PTH_0_15=1.0,r_ggH_PTH_15_30=1.0,r_ggH_PTH_30_45=1.0,r_ggH_PTH_45_80=1.0,r_ggH_PTH_80_120=1.0,r_ggH_PTH_120_200=1.0,r_ggH_PTH_200_350=1.0,r_ggH_PTH_350_600=1.0,r_ggH_PTH_GT600=1.0,r_ggH_PTH_600_10000=1.0',
        '--algo=grid',
        '--points=10',
        # '--split-points 2',
        ]
...
def debug_combination_Mar01(args):
    ...
    cmd = [
        ...
        '-P r_ggH_PTH_GT600',
        '--setParameterRanges r_ggH_PTH_0_15=0.0,4.0:r_ggH_PTH_15_30=0.0,4.0:r_ggH_PTH_30_45=0.0,4.0:r_ggH_PTH_45_80=0.0,4.0:r_ggH_PTH_80_120=0.0,4.0:r_ggH_PTH_120_200=0.0,4.0:r_ggH_PTH_200_350=0.0,4.0:r_ggH_PTH_350_600=0.0,4.0:r_ggH_PTH_GT600=0.0,4.0',
        '--setParameters r_ggH_PTH_0_15=1.0,r_ggH_PTH_15_30=1.0,r_ggH_PTH_30_45=1.0,r_ggH_PTH_45_80=1.0,r_ggH_PTH_80_120=1.0,r_ggH_PTH_120_200=1.0,r_ggH_PTH_200_350=1.0,r_ggH_PTH_350_600=1.0,r_ggH_PTH_GT600=1.0',
        '--algo=grid',
        '--points=5',
        # '--split-points 5',
